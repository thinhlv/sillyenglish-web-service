...
insert  into `battle_question`(`id`,`question_id`,`battle_id`,`attacker_answer`,`defender_answer`,`attacker_answer_time`,`defender_answer_time`) values (1,4,1,2,5,'2017-04-16 15:28:58',NULL),(2,5,1,5,5,NULL,NULL),(3,6,1,1,5,'2017-04-16 15:28:58',NULL),(4,1,1,1,5,'2017-04-16 15:28:59',NULL),(5,3,1,2,5,'2017-04-16 15:28:59',NULL),(8,1,2,1,5,'2017-04-16 15:29:08',NULL),(9,4,2,1,5,'2017-04-16 15:29:09',NULL),(10,6,2,2,5,'2017-04-16 15:29:09',NULL),(11,2,2,1,5,'2017-04-16 15:29:09',NULL),(12,5,2,1,5,'2017-04-16 15:29:10',NULL);
...
insert  into `battles`(`battle_id`,`attacker_id`,`defender_id`,`battle_status`,`date_create`,`attacker_begin_time`,`defender_begin_time`,`attacker_end_time`,`defender_end_time`,`victory_id`,`bet_value`) values (1,'b1d7dd8f11b32c9a0f66ea3c4416ca7f0aa02c80','7817469c39d0539775a545fd4357e671414fcbf3',1,'2017-04-16 15:28:56','2017-04-16 15:28:56',NULL,NULL,NULL,NULL,2000),(2,'b1d7dd8f11b32c9a0f66ea3c4416ca7f0aa02c80','7817469c39d0539775a545fd4357e671414fcbf3',1,'2017-04-16 15:29:07','2017-04-16 15:29:07',NULL,'2017-04-16 15:29:10',NULL,NULL,2000);
...
insert  into `error_code`(`error_id`,`code`,`details`) values (1,200,'completed'),(2,201,'not completed'),(3,202,'battle closed'),(4,203,'battle not found'),(5,204,'not enough coin to buy this lesson'),(6,205,'lesson was bought'),(7,206,'not enough money'),(8,207,'lesson wasn\'t bought');
...
insert  into `lesson`(`ls_id`,`ls_title`,`ls_price`,`ls_max_hear_times`,`ls_url`,`ls_download`,`ls_avatar_url`,`ls_rate`) values (4,'OBL St1 A Ghost in Love and Other Plays',140,5,'Resources/OBL St1 A Ghost in Love and Other Plays',0,'http://images.gr-assets.com/books/1348282197l/12600363.jpg',4.5),(5,'OBL St1 Goodbye, Mr. Hollywood',140,5,'Resources/OBL St1 Goodbye, Mr. Hollywood',0,'http://images.gr-assets.com/books/1356447934l/150869.jpg',3.7),(6,'OBL St1 Love or Money',140,5,'Resources\\OBL St1 Love or Money',0,'http://isach.info/images/story/cover/love_or_money__khong_xac_dinh.jpg',0);
...
insert  into `lesson_storage`(`st_id`,`ls_id`,`user_id`) values (13,1,'b1d7dd8f11b32c9a0f66ea3c4416ca7f0aa02c80'),(14,2,'b1d7dd8f11b32c9a0f66ea3c4416ca7f0aa02c80'),(15,4,'b1d7dd8f11b32c9a0f66ea3c4416ca7f0aa02c80');
...
/*Table structure for table `lesson_unit_tracker` */

DROP TABLE IF EXISTS `lesson_unit_tracker`;

CREATE TABLE `lesson_unit_tracker` (
  `lst_id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(40) DEFAULT NULL,
  `lu_id` int(11) DEFAULT NULL,
  `lst_progress` int(11) DEFAULT NULL,
  `lst_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`lst_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `lesson_unit_tracker` */
...
insert  into `mail`(`id`,`receiver`,`sender`,`content`,`date_create`,`mail_type`,`value`) values (1,'Dit con me may thang co ho!','b1d7dd8f11b32c9a0f66ea3c4416ca7f0aa02c80','Dit con me may thang co ho!','2017-04-16 15:28:56',2,1),(2,'Dit con me may thang co ho!','b1d7dd8f11b32c9a0f66ea3c4416ca7f0aa02c80','Dit con me may thang co ho!','2017-04-16 15:29:07',2,2);
...
insert  into `mail_type`(`id`,`type_name`,`details`) values (1,'GIFT_COIN','Sent gift as coin to user'),(2,'BATTLE_CHALLENGE','The battle challenge message');
...
insert  into `user`(`id`,`user_id`,`name`,`facebook_id`,`coin`,`rank`,`level`,`win_match`,`total_match`,`avatar_url`,`chain_for_rank`,`current_battle`) values (1,'b1d7dd8f11b32c9a0f66ea3c4416ca7f0aa02c80','sillyenglish',NULL,860,2000,2,10,20,'https://lh3.googleusercontent.com/KK4LGD1Z35Vx6ak2T8FA_abrhrDFLPUhjxo67lQ9uz5y0ZUo88fRHvHyzgOZ-udHsGI2-2gR58qyhv7RM1FnNVfiKDfD5zNNjYUCt8XnNtGl0KYL2fCBLAFdWsuaPgfMHlAR9w=s72-no','bronze_chain',0),(2,'7817469c39d0539775a545fd4357e671414fcbf3','Hu?nh Khoa Vin','728517987296641',1222,3333,4,54,222,'https://lh3.googleusercontent.com/6qz7e8EX3FuK88ywheGt21FiVW_4KRTqbSUyqlptRqNnf5v2PVvzpfy0Kvmm4k9gUeVD4LVK-IPRr6IZlIBvME4oXM2FQHoDnRdkU5QPWXgeLdLnjLZp7nJGx-7lrxA8QtyGxg=s72-no','bronze_chain',0),(3,'bc76c6649b2b7ab5b6d6f19292c4de33173c5ea7','OatOal','100006561107068',13025,52,5,10,30,'https://lh3.googleusercontent.com/zMP82p2OgZDPk_4f5basuBVSzle0x77qy1bZ9Pv6XheHIKX-C1OC4QYnWPVIqbAZsxtSAInl8YnTBtRdEPDsFbjr8YJxsFBpOD1ySb3YKQ93M0Lx93F6T_mN6chc_bBHgdKmRQ=s72-no','bronze_chain',0);
...
BEGIN
	select * from mail where mail.`receiver` = p_user_id;
    END */$$
DELIMITER ;
...
BEGIN
	...
	CALL sent_mail(p_attacker_id, p_defender_id, p_message, 2, @lastid);
...
BEGIN
	Delete from mail where mail.`id` = p_mail_id and mail.`user_id` = p_user_id;
	select 200 as "error_code";

...
insert  into `comment_notify`(`comment_id`,`user_id`,`notify_id`,`comment_content`,`comment_time`) values ('1','QILvqUWVZjgimSlRkKJjyAwbrok2','4','What’s fresher than fresh?','2017-06-01 05:48:27'),('2','QILvqUWVZjgimSlRkKJjyAwbrok2','4','awdawdasdaxczxcwefsxczxczxc','2017-06-01 11:00:36'),('3','QILvqUWVZjgimSlRkKJjyAwbrok2','4','awdawdasdaxczxcwefsxczxczxc','2017-06-01 17:26:40'),('4','QILvqUWVZjgimSlRkKJjyAwbrok2','4','so what?','2017-06-02 09:21:42'),('5','QILvqUWVZjgimSlRkKJjyAwbrok2','4','how are you','2017-06-02 09:23:05'),('6','QILvqUWVZjgimSlRkKJjyAwbrok2','4','why','2017-06-02 09:23:18');
...
CREATE TABLE `lesson` (
  ...
  `ls_rate_total` int(11) DEFAULT NULL,
  `ls_rate_person` int(11) DEFAULT NULL,
  PRIMARY KEY (`ls_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `lesson` */

insert  into `lesson`(`ls_id`,`ls_title`,`ls_price`,`ls_exp`,`ls_max_hear_times`,`ls_url`,`ls_download`,`ls_reading_content`,`ls_avatar_url`,`ls_file_url`,`ls_rate_total`,`ls_rate_person`) values ('4','OBL St1 A Ghost in Love and Other Plays','140',NULL,'2','Resources/OBL St1 A Ghost in Love and Other Plays','0',NULL,'http://images.gr-assets.com/books/1348282197l/12600363.jpg','Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/A%20Ghost%20in%20Love.pdf','90','20'),('5','OBL St1 Goodbye, Mr. Hollywood','140',NULL,'2','Resources/OBL St1 Goodbye, Mr. Hollywood','0',NULL,'http://images.gr-assets.com/books/1356447934l/150869.jpg','Resources/OBL%20St1%20Goodbye,%20Mr.%20Hollywood/Goodbye,_Mr_Hollywood.PDF','80','24'),('6','OBL St1 Love or Money','140',NULL,'2','Resources/OBL St1 Love or Money','0',NULL,'http://isach.info/images/story/cover/love_or_money__khong_xac_dinh.jpg','Resources/OBL%20St1%20Love%20or%20Money/Love%20or%20Money.PDF','100','28');
...
insert  into `lesson_unit`(`lu_id`,`lu_name`,`lu_sequence`,`ls_id`,`lu_max_hear`,`lu_url`,`lu_note`,`lu_type`,`lu_duration`) values ('31','1.mp3','0','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/01.mp3',NULL,NULL,'05:40'),('32','2.mp3','1','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/02.mp3',NULL,NULL,'06:31'),('33','3.mp3','2','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/03.mp3',NULL,NULL,'00:57'),('34','4.mp3','3','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/04.mp3',NULL,NULL,'02:45'),('35','5.mp3','4','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/05.mp3',NULL,NULL,'02:36'),('36','6.mp3','5','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/06.mp3',NULL,NULL,'04:11'),('37','7.mp3','6','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/07.mp3',NULL,NULL,'01:07'),('38','8.mp3','7','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/08.mp3',NULL,NULL,'02:24'),('39','9.mp3','8','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/09.mp3',NULL,NULL,'06:26'),('40','10.mp3','9','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/10.mp3',NULL,NULL,'01:11'),('41','11.mp3','10','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/11.mp3',NULL,NULL,'02:19'),('42','12.mp3','11','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/12.mp3',NULL,NULL,'03:24'),('43','13.mp3','12','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/13.mp3',NULL,NULL,'01:12'),('44','14.mp3','13','4',NULL,'Resources/OBL%20St1%20A%20Ghost%20in%20Love%20and%20Other%20Plays/14.mp3',NULL,NULL,'01:54'),('45','1.mp3','0','5',NULL,'Resources/OBL%20St1%20Goodbye,%20Mr.%20Hollywood/1.mp3',NULL,NULL,'11:25'),('46','2.mp3','1','5',NULL,'Resources/OBL%20St1%20Goodbye,%20Mr.%20Hollywood/2.mp3',NULL,NULL,'08:23'),('47','3.mp3','2','5',NULL,'Resources/OBL%20St1%20Goodbye,%20Mr.%20Hollywood/3.mp3',NULL,NULL,'06:50'),('48','4.mp3','3','5',NULL,'Resources/OBL%20St1%20Goodbye,%20Mr.%20Hollywood/4.mp3',NULL,NULL,'05:17'),('49','5.mp3','4','5',NULL,'Resources/OBL%20St1%20Goodbye,%20Mr.%20Hollywood/5.mp3',NULL,NULL,'07:22'),('50','6.mp3','5','5',NULL,'Resources/OBL%20St1%20Goodbye,%20Mr.%20Hollywood/6.mp3',NULL,NULL,'07:36'),('51','7.mp3','6','5',NULL,'Resources/OBL%20St1%20Goodbye,%20Mr.%20Hollywood/7.mp3',NULL,NULL,'08:13'),('52','8.mp3','7','5',NULL,'Resources/OBL%20St1%20Goodbye,%20Mr.%20Hollywood/8.mp3',NULL,NULL,'01:41'),('53','Rowena Akinyemi - Love or Money 1.mp3','0','6',NULL,'Resources/OBL%20St1%20Love%20or%20Money/Rowena%20Akinyemi%20-%20Love%20or%20Money%201.mp3',NULL,NULL,'05:41'),('54','Rowena Akinyemi - Love or Money 2.mp3','1','6',NULL,'Resources/OBL%20St1%20Love%20or%20Money/Rowena%20Akinyemi%20-%20Love%20or%20Money%202.mp3',NULL,NULL,'11:09'),('55','Rowena Akinyemi - Love or Money 3.mp3','2','6',NULL,'Resources/OBL%20St1%20Love%20or%20Money/Rowena%20Akinyemi%20-%20Love%20or%20Money%203.mp3',NULL,NULL,'11:36'),('56','Rowena Akinyemi - Love or Money 4.mp3','3','6',NULL,'Resources/OBL%20St1%20Love%20or%20Money/Rowena%20Akinyemi%20-%20Love%20or%20Money%204.mp3',NULL,NULL,'12:10'),('57','Rowena Akinyemi - Love or Money 5.mp3','4','6',NULL,'Resources/OBL%20St1%20Love%20or%20Money/Rowena%20Akinyemi%20-%20Love%20or%20Money%205.mp3',NULL,NULL,'10:20'),('58','Rowena Akinyemi - Love or Money 6.mp3','5','6',NULL,'Resources/OBL%20St1%20Love%20or%20Money/Rowena%20Akinyemi%20-%20Love%20or%20Money%206.mp3',NULL,NULL,'08:06'),('59','Rowena Akinyemi - Love or Money 7.mp3','6','6',NULL,'Resources/OBL%20St1%20Love%20or%20Money/Rowena%20Akinyemi%20-%20Love%20or%20Money%207.mp3',NULL,NULL,'14:05');
...
values (p_user_id,
        ...
        select * from `error_code` where `error_code`.`code` = 217;
    END */$$
DELIMITER ;
...
/* Procedure structure for procedure `get_notify_comments` */

/*!50003 DROP PROCEDURE IF EXISTS  `get_notify_comments` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `get_notify_comments`(
	in p_notify_id int(11)   
    )
BEGIN
	select 
	`comment_notify`.`notify_id`,
	`user`.`avatar_url`,
	`user`.`name`,
	TIMEDIFF(NOW(),`comment_notify`.`comment_time`) as `duration`,
	`comment_notify`.`comment_content`
	from `user`,`comment_notify`
	where `user`.`user_id` = `comment_notify`.`user_id` and `comment_notify`.`notify_id` = p_notify_id
	order by (`comment_notify`.`comment_time`) asc;
    END */$$
DELIMITER ;

/* Procedure structure for procedure `get_notify_detail` */

/*!50003 DROP PROCEDURE IF EXISTS  `get_notify_detail` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `get_notify_detail`(
		in p_notification_id int(11)
    )
BEGIN
		select `notification`.*, `comment_notify`.`user_id`,`comment_notify`.`comment_content`,`comment_notify`.`comment_time` from `notification`,`comment_notify` where `notification`.`notify_id` = `comment_notify`.`notify_id` order by (`comment_notify`.`comment_time`) desc;
    END */$$
DELIMITER ;
...
BEGIN
	select `notification`.`notify_id`,`user`.`avatar_url`,`user`.`name`,`notification`.`user_location`,TIME_TO_SEC(TIMEDIFF(NOW(),`notification`.`post_time`)) as `duration`,`notification`.`notify_content`,`notification`.`like_count`,`notification`.`comment_count`	
	from `notification`,`friends`,`user`
	where 	(
		(`notification`.`user_id` = `friends`.`person_1` AND `friends`.`person_2` = p_user_id) OR
		(`notification`.`user_id` = `friends`.`person_2` AND `friends`.`person_1` = p_user_id) OR
		(`notification`.`user_id` = p_user_id) and
...
/* Procedure structure for procedure `get_user_notification_profile` */

/*!50003 DROP PROCEDURE IF EXISTS  `get_user_notification_profile` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `get_user_notification_profile`(
		in p_user_id varchar(50),
...
BEGIN
	if(p_limit_amount > 0) then
			...
			SELECT `notification`.`notify_id`,`user`.`avatar_url`,`user`.`name`,`notification`.`user_location`,TIMEDIFF(NOW(),`notification`.`post_time`) AS `duration`,`notification`.`notify_content`,`notification`.`like_count`,`notification`.`comment_count`	
			FROM `notification`,`user`
			where `notification`.`user_id` = p_user_id and `user`.`user_id` = p_user_id
			order by(`notification`.`post_time`) desc limit p_limit_amount;
		...
		SELECT `notification`.`notify_id`,`user`.`avatar_url`,`user`.`name`,`notification`.`user_location`,TIMEDIFF(NOW(),`notification`.`post_time`) AS `duration`,`notification`.`notify_content`,`notification`.`like_count`,`notification`.`comment_count`	
			FROM `notification`,`user`
			WHERE `notification`.`user_id` = p_user_id AND `user`.`user_id` = p_user_id
			ORDER BY(`notification`.`post_time`) DESC;
	end if;
    END */$$
DELIMITER ;

...
insert  into `battle_question`(`id`,`question_id`,`battle_id`,`attacker_answer`,`defender_answer`,`attacker_answer_time`,`defender_answer_time`) values (146,1,22,2,2,'2017-03-13 20:35:28','2017-03-12 21:06:51'),(147,5,22,2,2,'2017-03-13 20:35:34','2017-03-12 22:43:31'),(148,6,22,2,1,'2017-03-13 20:35:48','2017-03-13 20:33:45'),(149,4,22,1,2,'2017-03-13 20:35:22','2017-03-13 20:33:52'),(150,2,22,1,1,'2017-03-13 20:34:48','2017-03-13 20:33:59');
...
insert  into `battles`(`battle_id`,`attacker_id`,`defender_id`,`battle_status`,`date_create`,`attacker_begin_time`,`defender_begin_time`,`attacker_end_time`,`defender_end_time`,`victory_id`) values (22,'7817469c39d0539775a545fd4357e671414fcbf3','bc76c6649b2b7ab5b6d6f19292c4de33173c5ea7',2,'2017-03-12 21:04:58','2017-03-12 21:04:58','2017-03-13 20:32:53','2017-03-13 20:35:48','2017-03-13 20:33:59','bc76c6649b2b7ab5b6d6f19292c4de33173c5ea7');
...
insert  into `parameter`(`param_id`,`value`,`detais`) values ('max_answer_time',5,'Max answer time (Minute)');
...
BEGIN
		call check_battle_end_time(p_battle_id, p_user_id);
...
BEGIN
	...
	SELECT `parameter`.`value` FROM parameter WHERE `parameter`.`param_id` = "max_answer_time" INTO @max_answer_time;
	SELECT IF(battles.`attacker_id` = p_user_id, 1, 0) AS checker FROM battles WHERE (battles.`battle_id` = p_battle_id) INTO @checker;
	
	IF(@checker = 1)
	THEN
		SELECT battles.`attacker_begin_time` FROM battles WHERE battles.`battle_id` = p_battle_id INTO @attacker_begin_time;
		...
		END IF;
	ELSE
		SELECT battles.`defender_begin_time` FROM battles WHERE battles.`battle_id` = p_battle_id INTO @defender_begin_time;
	...
	/*If battle has completed*/
		...
		IF(@total_attacker_answer = @total_defender_answer) THEN
			...
			IF(@attacker_time = @defender_time) THEN
				...
				SELECT "Draw battle" AS winner;
			END IF;
			
		END IF;
	else
	/*If battle not completed yet*/
	Select "not completed yet" as battle_state;
